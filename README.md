...
```bibtex
@software{advanced_rag_comparison,
  title = {Advanced RAG Comparison: A Framework for Evaluating Retrieval Methods},
  author = {Your Name},
  year = {2024},
  url = {https://github.com/yourusername/advanced-rag-comparison}
}
```
...
- [ ] Support for more retrieval methods (ColBERT, dense passage retrieval)
...
Built with passion for better RAG systems.